...
Load `.github/agent-runtime/kernel.md` first. Load the full governance docs (`docs/agents/responsibility-matrix.md`, ADR-0014) only when acting as an API gate or when the kernel is insufficient.
