...
feels treasure + cozy** in each of the 7 target languages before the "name day".

---

## How to run (≈5–10 min per speaker)
...
4. Also run a quick **dictionary/slang search** in that language for the written
   form and its local cognate.
5. Compile results into the summary table; a name with any **1–2 rating or
   flagged accidental meaning** fails.

---

## The 5 questions (ask in the speaker's language)

1. **Natural:** Does it sound natural, or like a foreign word you'd stumble on?
2. **Meaning:** Does it (or a close cognate) mean anything awkward, rude, or
   off-brand? Any embarrassing homophone?
3. **Vibe:** Does it feel *treasure* + *cozy* — a warm, safe place where you
   keep the things you love?
4. **Mispronunciation risk:** Would people mispronounce or misspell it? What
   would they actually type when they search for it?
5. **Fit:** Could you imagine it as an app for cataloging records and books?

**Ratings (fill in):**
- **Naturalness:** 1–5 (5 = perfectly natural)
- **Vibe (treasure+cozy):** 1–5 (5 = strong)
...
> alcova), all meaning a recessed nook or cozy chamber — no negative meanings
> found in desk research. This sheet exists to confirm that with real speakers.

---

## Scorecard (fill per speaker)

| Lang | Speaker | Q1 Natural | Q2 Meaning flag? | Q3 Vibe (1–5) | Q4 Mispron/misspell note | Q5 Fit | Naturalness (1–5) | OK? |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| EN | 1 / 2 |  |  |  |  |  |  |  |
| FR | 1 / 2 |  |  |  |  |  |  |  |
| PT | 1 / 2 |  |  |  |  |  |  |  |
...
**Fail rule:** any **1–2 on Naturalness or Vibe**, or any flagged accidental
meaning, fails the name for that market → report back to the Marketing Manager
with the exact quote before the "name day".
...
| Check | Result |
| --- | --- |
| 7 languages × 2 native speakers interviewed | ☐ |
