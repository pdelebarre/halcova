# Halcova — Design Redesign Spec

A design-forward, implementation-ready spec for modernizing Halcova's UI/UX
...
- **Left:** wordmark "Halcova" (Fraunces 24, weight 700). The tagline moves out of the header — it belongs in the empty state, not the chrome.
