...
export const recordsCatalog = {
  kind: 'records',
  entity: 'record',
  collectionLabel: 'crate', // "your crate"
  ...
  copy: {
    ...
    filtersActive: (n) => `${n} filter${n === 1 ? '' : 's'} active`,
    filterSheet: {
      title: 'Filters',
      format: 'Format',
      genre: 'Genre',
...
export const booksCatalog = {
  kind: 'books',
  entity: 'book',
  collectionLabel: 'shelf', // "your shelf"
