...
export async function adminApprove({ requestId, collections }) {
  return postJson(ADMIN_URL, { action: 'approve', requestId, collections }, getAccessCode())
}
...
export async function adminUpdateUser({ userId, collections, status }) {
  return postJson(ADMIN_URL, { action: 'updateUser', userId, collections, status }, getAccessCode())
}
