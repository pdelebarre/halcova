...
const fr = {
  ...
  'admin.rotateCode': 'Changer le code',
  'admin.newCodeFor': 'Nouveau code pour {name}',
  'admin.rotatedHint': "L'ancien code ne fonctionne plus — partagez ce nouveau code en dehors de l'app.",
  ...
  'credits.aboutNameBody': '« Halcova » est un vrai mot qui signifie « alcôve » — un recoin chaleureux et douillet où l\'on garde ses trésors. Il est presque identique dans les langues romanes : alcôve en français, alcova en espagnol, en italien et en portugais, alkoof en néerlandais, Alkoven en allemand. Il relie les disques et les livres sans privilégier un support — il nomme simplement l\'endroit où vit votre collection. Choisi pour un public international, à travers nos huit langues prises en charge, et l\'esthétique sombre des collectionneurs.',
  ...
  'games.featureLabel': 'Jeux',
  'games.featureHint': 'Débloquez le hub Play — persona, quiz, XP, histoires d\'étagère — pour ce membre.',
  ...
  // A5.6 (#117): EN master — native FR translation pending (see
  ...
  // gloss as a natural collector equivalent (e.g. "place"), not a literal
  ...
  // Admin dashboard (ADMIN-EPIC-1, #262) — onglet + libellés des cartes + badge.
  'admin.tab.dashboard': 'Tableau de bord',
  'admin.dashboard.title': 'Tableau de bord',
  'admin.dashboard.empty': 'Pas encore de données.',
  'admin.dashboard.retry': 'Réessayer',
  'admin.dashboard.updated': 'Mis à jour {time}',
  'admin.dashboard.pendingBadge': '{n} demande(s) en attente',
  'admin.dashboard.section.pending': 'Demandes en attente',
  'admin.dashboard.pendingCaption': 'En attente de votre approbation',
  'admin.dashboard.section.members': 'Membres',
  'admin.dashboard.member.total': 'Total de membres',
  'admin.dashboard.member.active': 'Actifs',
  'admin.dashboard.member.disabled': 'Désactivés',
  'admin.dashboard.section.signups': 'Inscriptions',
  'admin.dashboard.signup.today': 'Aujourd\'hui',
  'admin.dashboard.signup.week': 'Cette semaine',
  'admin.dashboard.signup.month': 'Ce mois-ci',
  'admin.dashboard.signup.total': 'Total',
  'admin.dashboard.section.plans': 'Formules',
  'admin.dashboard.plan.free': 'Gratuit',
  'admin.dashboard.plan.premium': 'Premium',
  'admin.dashboard.plan.lifetime': 'À vie',
  'admin.dashboard.plan.unlimited': 'Illimité',
  'admin.dashboard.section.collection': 'Taille de la collection',
  'admin.dashboard.collection.records': 'Disques',
  'admin.dashboard.collection.books': 'Livres',
  'admin.dashboard.section.feedback': 'Feedback',
  'admin.dashboard.feedback.total': 'Total',
  'admin.dashboard.section.reviews': 'Avis',
  'admin.dashboard.review.total': 'Total',
  'admin.dashboard.review.published': 'Publiés',
  'admin.dashboard.review.pending': 'En attente',
  'admin.dashboard.review.hidden': 'Masqués',
}
