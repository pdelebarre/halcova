...
const enGB = {
  ...
  // §19 In-app feedback (epic #74, T5 #82 → T7 #79) — mirrors en: no GB/US
  // spelling divergence in this block (no "catalog/catalogue" style words), so
  // all feedback keys inherit the en baseline. Proper nouns stay as-is.
  ...
  // Admin feedback inbox (epic #74, T6 #75 → T7 #79) — mirrors en.
